...
---
description: Component compliance analysis with quality scoring
capability: common
---
# Workflow: mcp:analyze
...
## Execution
!python3 .skt/shared/claudekit/scripts/query-workflow.py mcp:analyze $argv
