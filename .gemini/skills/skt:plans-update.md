...
---
description: Update plan status and tasks based on code changes
capability: common
---
# Workflow: plans-update
...
## Execution
!python3 .skt/shared/claudekit/scripts/query-workflow.py plans-update $argv
