...
---
description: External documentation research via MCP
capability: advanced
---
# Workflow: mcp:docs-lookup
...
## Execution
!python3 .skt/shared/claudekit/scripts/query-workflow.py mcp:docs-lookup $argv
