...
---
description: Summarize active implementation plans and roadmap
capability: common
---
# Workflow: plans-summarize
...
## Execution
!python3 .skt/shared/claudekit/scripts/query-workflow.py plans-summarize $argv
