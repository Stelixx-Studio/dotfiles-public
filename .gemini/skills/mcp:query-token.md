...
---
description: Query design tokens from MCP server (spacing colors sizing etc)
capability: common
---
# Workflow: mcp:query-token
...
## Execution
!python3 .skt/shared/claudekit/scripts/query-workflow.py mcp:query-token $argv
