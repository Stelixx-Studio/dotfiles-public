...
---
description: Deep exploration mode for complex brainstorming with extended thinking
capability: advanced
---
# Workflow: ultrathink
...
## Execution
!python3 .skt/shared/claudekit/scripts/query-workflow.py ultrathink $argv
