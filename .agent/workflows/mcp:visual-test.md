...
---
description: Visual regression testing with token validation
capability: advanced
---
# Workflow: mcp:visual-test
...
## Execution
!python3 .skt/shared/claudekit/scripts/query-workflow.py mcp:visual-test $argv
