...
---
description: Design token usage pattern analysis and research
capability: common
---
# Workflow: mcp:research
...
## Execution
!python3 .skt/shared/claudekit/scripts/query-workflow.py mcp:research $argv
